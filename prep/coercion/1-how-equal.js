...
//passed into the function are loosely equal. howEqual should return 
//'strictly' if the two values are strictly equal. howEqual should 
//return the string 'not equal' if the two values are neither 
//strictly nor loosely equal.
