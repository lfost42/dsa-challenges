...
Do not use the built in .slice string method. Feel free to use it 
...
/*
I set up the loop based on whether the argument was passed into 
the function. This allowed the values for start and end to be 0 
if startIdx was undefined and string.length if endIdx was 
undefined. 
*/
