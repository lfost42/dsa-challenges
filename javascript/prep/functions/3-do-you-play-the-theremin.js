...
an argument. 
//doYouPlayTheTheremin should return true if the inputted string 
starts with the letters s or S.
...
//The logical operation sets the string to lower case and checks 
if it starts with 's'.
